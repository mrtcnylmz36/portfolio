...
const Contact = () => {
  ...
  return (
    <section class="py-16 bg-gray-100 font-poppins dark:bg-transparent dark:text-white">
      <div class="justify-center flex-1 max-w-5xl px-4 py-4 mx-auto lg:py-10 md:px-7">
          ...
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              ...
              <h1 class="text-5xl font-bold dark:text-white">
                {" "}
                Our <span class="text-sky-500"> Contact</span>{" "}
              </h1>
              <div class="flex w-24 mt-1 mb-10 overflow-hidden rounded">
                <div class="flex-1 h-2 bg-sky-200"></div>
                <div class="flex-1 h-2 bg-sky-400"></div>
                <div class="flex-1 h-2 bg-sky-600"></div>
              </div>
            </div>
        ...
        <div class="flex flex-wrap mb-8 -mx-4">
          <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
            <div class="h-full py-12 text-center transition-all rounded-lg shadow dark:bg-gray-800 bg-gray-50 hover:shadow-lg">
              <div class="inline-flex items-center justify-center w-12 h-12 mb-6 text-gray-100 bg-sky-500 rounded-full dark:bg-sky-500">
                <svg
          ...
          <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
            <div class="h-full py-12 text-center transition-all rounded-lg shadow dark:bg-gray-800 bg-gray-50 hover:shadow-lg">
              ...
              <a
                href="#"
                class="inline-block mr-4 text-sky-600 dark:text-sky-400 dark:hover:text-sky-300 hover:text-sky-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <a
                href="#"
                class="inline-block mr-4 text-sky-400 dark:text-sky-400 dark:hover:text-sky-300 hover:text-sky-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
              ...
              <a
                href="#"
                class="inline-block mr-4 text-sky-500 hover:text-sky-600 dark:text-sky-400 dark:hover:text-sky-300"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
        ...
        <div class="px-8 py-8 bg-white border rounded-md shadow-md dark:border-gray-800 dark:bg-gray-800">
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              class="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-sky-600 rounded-md dark:bg-sky-500 dark:hover:bg-sky-600 hover:bg-sky-700"
              disabled={loading}
            >
              {loading ? (
